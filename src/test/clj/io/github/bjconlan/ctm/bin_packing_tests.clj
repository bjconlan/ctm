...
(deftest best-fit-decreasing-tests
  (testing "Under fill"
    [(are [weights capacities results]
       (= results (bin-packing/best-fit-decreasing weights capacities))
       [1 2 3 4] [12] [[3 2 1 0]]
       [1 2 3 4] [6 6] [[3 1] [2 0]]
  ...
  (testing "Negative weightings"
    [(are [weights capacities]
       (thrown-with-msg? AssertionError #"every?" (bin-packing/best-fit-decreasing weights capacities))
       [-1] [0]
       [0] [-1])]))